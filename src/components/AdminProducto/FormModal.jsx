    ...
    <div className="relative p-4 w-full max-w-2xl h-full md:h-auto m-auto">
          ...
          <div className="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <form action="#">
              ...
              <button type="submit" className=" inline-flex items-center bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                ➕
                Add new product
              </button>
            </form>
